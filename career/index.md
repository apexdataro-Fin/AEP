...
title: Career Paths
slug: /career
description: Guided career paths for cloud engineering roles — from junior to architect
ai_metadata:
  category: career
  difficulty: beginner
...
```mermaid
graph LR
    A[Junior Cloud Engineer] --> B[Cloud Engineer]
    B --> C[Senior Cloud Engineer]
    C --> D[Solutions Architect]
    C --> E[DevOps Engineer]
    C --> F[SRE]
    D --> G[Principal Architect]
