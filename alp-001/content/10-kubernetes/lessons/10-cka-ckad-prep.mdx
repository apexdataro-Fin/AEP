...
search_keywords:
  ["cka exam preparation", "ckad study guide", "kubernetes certification", "cka tips"]
learning_objectives:
  ...
  questions={[
    {
      ...
      correct: 1,
      explanation:
        "Imperative commands with `--dry-run=client -o yaml` save enormous time. You generate the skeleton and tweak it, rather than writing 20+ lines from memory.",
    },
    {
      ...
      correct: 1,
      explanation:
        "Troubleshooting is 30% of the CKA exam — the largest single domain. Practice diagnosing broken clusters, pods, and networking issues extensively.",
    },
    {
      ...
      correct: 1,
      explanation:
        "Every question specifies a context. If you answer in the wrong context, you get zero points even if your solution is perfect.",
    },
  ]}
/>
...
<KnowledgeLinks>
  - **Previous**: [Operators & CRDs](operators-crds) - **Start of Module**: [Kubernetes
  Architecture](k8s-architecture) - **Related**: [Certification Center](/certifications) -
