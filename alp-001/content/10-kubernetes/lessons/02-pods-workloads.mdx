...
knowledge_nodes: ["pods", "deployments", "replicasets", "statefulsets", "daemonsets", "pod-lifecycle"]
tags: ["kubernetes", "pods", "workloads", "deployments", "statefulsets"]
status: "published"
version: "1.0.0"
author: "ARES EDU PLATFORM"
last_updated: "2026-07-15"
search_keywords: ["kubernetes pods", "deployments", "statefulsets", "daemonsets", "k8s workloads", "pod lifecycle"]
learning_objectives:
  ...
  questions={[
    {
      ...
      correct: 1,
      explanation: "Pods encapsulate containers that need to share network namespace, volumes, and lifecycle. The sidecar/ambassador patterns depend on this shared context."
    },
    {
      ...
      correct: 1,
      explanation: "StatefulSets give each pod a stable hostname (e.g., postgres-0) and its own PVC, essential for stateful workloads like databases."
    },
    {
      ...
      correct: 1,
      explanation: "DaemonSets run a copy of a pod on each node (or a labeled subset), commonly used for logging agents, monitoring, and network plugins."
    }
  ]}
/>
...
<KnowledgeLinks>
- **Next**: [Services & Networking](services-networking) — Exposing your workloads
- **Previous**: [Kubernetes Architecture](k8s-architecture) — The foundation
- **Lab**: Multi-tier application deployment
- **Certification**: CKAD Domain 2 — Application Deployment (20%)
</KnowledgeLinks>
