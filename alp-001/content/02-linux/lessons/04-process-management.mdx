...
1. **You `kill -9` a database process. What happens?**
   ...
   <details>
     <summary>Answer</summary>**B.** SIGKILL terminates immediately with no cleanup. The database
     cannot flush buffers, close connections, or release locks. Always try SIGTERM first.
   </details>
