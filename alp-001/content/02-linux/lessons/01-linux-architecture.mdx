...
1. **Which of these components runs in kernel space?**
   ...
   <details><summary>Answer</summary>**C.** The process scheduler is part of the kernel. Everything else runs in user space.</details>
...
2. **Why should you never run production services as root?**
   ...
   <details><summary>Answer</summary>**B.** Root has unlimited power. A compromised or buggy process running as root can delete everything, modify any file, or install malware. Always use the least-privileged user possible.</details>

---

## Hands-On

<Exercise title="Explore Your Linux System"
