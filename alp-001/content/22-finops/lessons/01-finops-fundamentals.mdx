...
<CodeBlock language="kql" title="Find Unattached Managed Disks ($$$ waste)">
  ...
  project name, resourceGroup, diskSizeGB = properties.diskSizeGB, monthlyCost =
  properties.diskSizeGB * 0.05 // $0.05/GB | order by monthlyCost desc
</CodeBlock>
...
<Quiz>
  <Question
    ...
    options={[
      "Start buying reservations",
      "Inform — get visibility into spending",
      "Fire people for spending too much",
      "Ignore costs until the bill comes",
    ]}
    correct={1}
