...
**Observability** is the ability to understand a system's internal state from its external outputs. More than monitoring (which tells you _that_ something is wrong), observability tells you _why_ — even for problems you've never seen before.
