...
<CodeBlock language="yaml" title=".github/dependabot.yml">
  version: 2 updates: # Terraform modules - package-ecosystem: "terraform" directory: "/terraform"
  schedule: interval: "weekly" day: "monday" labels: - "dependencies" - "terraform" reviewers: -
  "team/platform" # Python dependencies - package-ecosystem: "pip" directory: "/scripts" schedule:
  interval: "daily" open-pull-requests-limit: 5 # GitHub Actions themselves - package-ecosystem:
