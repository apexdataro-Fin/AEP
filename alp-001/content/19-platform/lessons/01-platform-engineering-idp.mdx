...
<CodeBlock language="yaml" title="Backstage Component Definition">
  apiVersion: backstage.io/v1alpha1 kind: Component metadata: name: cloudnova-payments description:
  Payment processing service annotations: github.com/project-slug: apexdataro-Fin/cloudnova-payments
  backstage.io/techdocs-ref: dir:. spec: type: service lifecycle: production owner: team-payments
  system: cloudnova-platform providesApis: - cloudnova-payments-api dependsOn: -
