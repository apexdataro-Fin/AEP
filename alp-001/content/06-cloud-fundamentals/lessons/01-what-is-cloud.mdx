...
<Definition term="Cloud Computing">
  ...
  configurable computing resources (networks, servers, storage, applications, and services) that can
...
1. **Which is NOT one of the 5 essential characteristics of cloud computing?**
   ...
   <details>
     <summary>Answer</summary>**C.** Cloud computing means you DON'T own the physical hardware —
     that's the point. The provider owns and manages it.
   </details>
...
2. **A company buys servers for $200,000. Is this CapEx or OpEx?**
   ...
   <details>
     <summary>Answer</summary>**A.** CapEx — capital expenditure. Upfront investment in physical
     assets. Cloud shifts this to OpEx — paying monthly for what you use.
   </details>
...
3. **CloudNova handles GDPR data. Should they use public or private cloud?**
   ...
   <details>
     <summary>Answer</summary>**B.** All major cloud providers are GDPR compliant. You still need to
     configure services correctly (encryption, data residency, access controls), but public cloud is
     absolutely viable for regulated workloads.
   </details>
