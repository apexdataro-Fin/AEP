...
Green nodes = can be done in parallel. Yellow = depends on green. Purple = depends on everything before it. This is your execution order.
</BestPractice>
...
1. **What is the correct order for problem decomposition?**
   ...
   <details><summary>Answer</summary>**B.** Always define the problem first, then break it down, map what depends on what, then solve.</details>
...
2. **A deployment fails. The 5 Whys lead you to "no code review checklist." What's the real fix?**
   ...
   <details><summary>Answer</summary>**C.** The 5 Whys leads to process fixes, not blame. Adding to the checklist prevents this class of bug forever.</details>
