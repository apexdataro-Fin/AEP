...
certifications: []
knowledge_nodes: ["learning-how-to-learn", "spaced-repetition", "active-recall", "feynman-technique"]
learning_objectives:
  - id: "obj-1"
...
search_keywords: [how to learn fast, spaced repetition, active recall, feynman technique, study system]
---
...
1. **Why is re-reading less effective than testing yourself?**
   ...
   <details><summary>Answer</summary>**B.** Recognition ("I've seen this before") is not recall ("I can explain this from memory"). Tests force retrieval, which strengthens memory.</details>
...
2. **What's the optimal review schedule for long-term retention?**
   ...
   <details><summary>Answer</summary>**C.** Expanding intervals are optimal — you review just before you'd forget, strengthening the memory efficiently.</details>
