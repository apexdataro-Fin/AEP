...
related_lessons: []
certifications: []
knowledge_nodes: ["systems-thinking", "feedback-loops", "emergent-behavior", "failure-mode-analysis"]
learning_objectives:
  - id: "obj-1"
...
For every component, ask: "If this fails, what breaks? How do we detect it? How do we recover? How long does recovery take?"
</BestPractice>
