...
<Tabs>
  <TabItem value="aws" label="AWS VPC" default>
    AWS VPC is the foundational networking service in AWS.
    Every AWS account comes with a default VPC in each region.
  </TabItem>
  <TabItem value="azure" label="Azure VNet">
    Azure Virtual Network (VNet) is the equivalent service.
    VNets provide similar isolation and control.
  </TabItem>
  <TabItem value="gcp" label="GCP VPC">
    GCP VPC networks are global — subnets span regions.
    This is a key architectural difference from AWS and Azure.
  </TabItem>
</Tabs>
