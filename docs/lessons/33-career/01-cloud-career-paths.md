...
description: "خريطة المسار الوظيفي: من Junior إلى Cloud Architect — المهارات، الشهادات، الرواتب، التفاوض، وبناء العلامة الشخصية."
---
...
```mermaid
graph TD
    A[Junior Cloud Engineer] -->|AZ-900 + مشروعين| B[Cloud Engineer]
    B -->|AZ-104 + CKA + قيادة مشاريع| C[Senior Cloud Engineer]
    C -->|AZ-305 + System Design| D[Cloud Architect]
    C -->|Tech Lead| E[Engineering Manager]
    D -->|خبرة 10+ سنوات| F[Principal Architect]
    E -->|MBA أو خبرة| G[Director of Engineering]
    F --> G
```
