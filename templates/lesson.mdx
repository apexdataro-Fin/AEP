...
<Debugging scenario="Scenario" symptoms={["Symptom 1"]} diagnosis="Diagnosis steps" solution="Solution" />

## Architecture Decision

<DecisionPoint options={["Option A", "Option B"]} criteria={["Cost", "Performance"]} recommendation="Option B" />

## Interview Preparation

<InterviewQuestion question="Interview question?" expectedTopics={["Topic 1"]} difficulty="medium" careerLevel="cloud_engineer" />
