...
const projects = [
  {
    ...
    name: "Linux Server",
    status: "completed",
    desc: "Provision and secure a Linux server.",
  },
  {
    id: "P2",
    name: "Secure Server",
    status: "completed",
    desc: "Harden the server with SSH, firewalls, and users.",
  },
  {
    id: "P3",
    name: "Python Automation",
    status: "in-progress",
    desc: "Automate cloud tasks with Python.",
  },
  {
    id: "P4",
    name: "Azure Infrastructure",
    status: "locked",
    desc: "Deploy a scalable Azure landing zone.",
  },
  {
    id: "P5",
    name: "Dockerized Services",
    status: "locked",
    desc: "Containerize applications with Docker.",
  },
  ...
  { id: "P8", name: "Monitoring Stack", status: "locked", desc: "Add observability and alerting." },
  {
    ...
    status: "locked",
    desc: "Deploy ML inference and vector search.",
  },
  {
    id: "P10",
    name: "Production Cloud Platform",
    status: "locked",
    desc: "Combine everything into one platform.",
  },
];
...
export default function ProjectsPage(): ReactNode {
  return (
    <Layout
      title="Projects"
      description="Build one connected cloud platform across 10 cumulative projects."
    >
        ...
        <div className="container">
          ...
          <div className={projectsStyles.timeline}>
            {projects.map((p, i) => (
              <div
                key={p.id}
                className={`${projectsStyles.timelineItem} ${projectsStyles[p.status]}`}
              >
