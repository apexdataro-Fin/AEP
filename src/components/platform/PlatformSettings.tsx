    ...
    >
      ...
      >
        ...
        >
          ...
          <button onClick={onClose} className="aep-btn aep-btn--ghost aep-btn--icon">
            ✕
          </button>
        </div>
        ...
        >
          ...
          <SettingGroup label="Appearance">
            <SettingRow label="Theme">
              <Select
                ...
                onChange={(v) => update({ theme: v as UserPreferences["theme"] })}
                options={[
            ...
            <SettingRow label="Font Size">
              <Select
                ...
                onChange={(v) => update({ fontSize: v as UserPreferences["fontSize"] })}
                options={[
            ...
            <SettingRow label="Reading Width">
              <Select
                ...
                onChange={(v) => update({ readingWidth: v as UserPreferences["readingWidth"] })}
                options={[
            ...
            <SettingRow label="Dyslexia Friendly Font">
              <Toggle
                ...
                onChange={(v) => update({ dyslexiaFriendlyFont: v })}
              />
            </SettingRow>
          </SettingGroup>
          ...
          <SettingGroup label="Learning Preferences">
            <SettingRow label="Learning Mode">
              <Select
                ...
                onChange={(v) =>
                  update({ learningMode: v as "self-paced" | "structured" | "bootcamp" })
                }
                options={[
          ...
          <SettingGroup label="AI Preferences">
            <SettingRow label="AI Features">
              <Toggle
                checked={preferences.aiPreferences.enabled}
                onChange={(v) =>
                  update({ aiPreferences: { ...preferences.aiPreferences, enabled: v } })
                }
              />
            </SettingRow>
            <SettingRow label="Auto-Suggest">
              <Toggle
                checked={preferences.aiPreferences.autoSuggest}
                onChange={(v) =>
                  update({ aiPreferences: { ...preferences.aiPreferences, autoSuggest: v } })
                }
              />
            </SettingRow>
            <SettingRow label="Difficulty Adaptation">
              <Toggle
                checked={preferences.aiPreferences.difficultyAdaptation}
                onChange={(v) =>
                  update({
                    aiPreferences: { ...preferences.aiPreferences, difficultyAdaptation: v },
                  })
                }
              />
            </SettingRow>
          ...
          <SettingGroup label="Notifications">
            <SettingRow label="Review Reminders">
              <Toggle
                checked={preferences.notificationPreferences.reviewReminders}
                onChange={(v) =>
                  update({
                    notificationPreferences: {
            ...
            <SettingRow label="Streak Alerts">
              <Toggle
                checked={preferences.notificationPreferences.streakAlerts}
                onChange={(v) =>
                  update({
                    notificationPreferences: {
                      ...preferences.notificationPreferences,
            ...
            <SettingRow label="Achievements">
              <Toggle
                checked={preferences.notificationPreferences.achievementAlerts}
                onChange={(v) =>
                  update({
                    notificationPreferences: {
                      ...preferences.notificationPreferences,
            ...
            <SettingRow label="Weekly Report">
              <Toggle
                checked={preferences.notificationPreferences.weeklyReport}
                onChange={(v) =>
                  update({
                    notificationPreferences: {
                      ...preferences.notificationPreferences,
    ...
    >
      <span
        style={{
          ...
          borderRadius: "50%",
          background: "#fff",
          transition: "left var(--aep-transition)",
        }}
      />
    </button>
  );
